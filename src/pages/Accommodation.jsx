...
const Accommodation = () => {
  ...
  const [selectedAccommodation, setSelectedAccommodation] = useState(null); // State to hold selected accommodation for checkout
  ...
  // Handle the Book Now button click to open modal
