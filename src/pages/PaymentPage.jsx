...
const PaymentPage = () => {
  ...
  // Dynamically load the PayPal script when the component mounts
  useEffect(() => {
    const script = document.createElement('script');
    script.src = "https://www.paypal.com/sdk/js?client-id=YOUR_PAYPAL_CLIENT_ID"; // Replace with your PayPal client ID
    script.async = true;
    script.onload = () => {
      // Once the PayPal script has loaded, render the PayPal button
      window.paypal.Buttons({
        createOrder: (data, actions) => {
          return actions.order.create({
            purchase_units: [
              {
                amount: {
                  value: totalAmount.toFixed(2), // Use totalAmount dynamically
                },
        ...
        onApprove: (data, actions) => {
          return actions.order.capture().then((details) => {
            ...
            // You can redirect or update state after payment
      ...
      }).render("#paypal-button-container"); // This will render the PayPal button
    };
            ...
            <div className="bg-gray-100 p-6 border rounded-lg">
              <form action="/action_page.php">
                ...
                <div className="mb-6">
                  ...
                  <label htmlFor="cname" className="block text-sm font-semibold text-gray-700 mb-2">Name on Card</label>
                  ...
                  <label htmlFor="ccnum" className="block text-sm font-semibold text-gray-700 mb-2">Credit card number</label>
                  ...
                  <label htmlFor="expmonth" className="block text-sm font-semibold text-gray-700 mb-2">Exp Month</label>
                  ...
                  <div className="flex space-x-4">
                    <div className="w-1/2">
                      <label htmlFor="expyear" className="block text-sm font-semibold text-gray-700 mb-2">Exp Year</label>
